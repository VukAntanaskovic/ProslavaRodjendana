...
%>
<h1 style="color:blue; text-align:center;" id="poruka-naslov"></h1>
<div class="container" id="main-agencije" ng-controller="agencijePretragaController">
...
<input type="time" class="form-control" required name="vremeDo"></div>
    ...
    <% 
     ...
     <div  class="poruka" style="background:tomato;">
        <p>Trazena agencija ne postoji u bazi <button type="button" onclick="zatvoriPoruku()">x</button></p>
    </div>
    <style>
    .poruka{
    display:block;
