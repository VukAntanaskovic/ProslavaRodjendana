...
<table class="table table-dark table-striped">
  ...
  <tbody ng-controller="agencijeMenadzerController">
    <tr ng-repeat="x in agencijeMenadzer" id="tabela_agencije">
      <td>{{x.agn_sifra}}</td>
      <td>{{x.agn_naziv}}</td>
      <td>{{x.agn_adresa}}</td>
      <td>{{x.agn_telefon}}</td>
...
<textarea id="opisTextArea" type="file" class="form-control" placeholder="Unesite opis" name="opis" required></textarea>
    ...
    <div id="popup-forma-zelena">
        ...
        <form action="AzurirajAgencijeMenadzerServlet" method="POST">
