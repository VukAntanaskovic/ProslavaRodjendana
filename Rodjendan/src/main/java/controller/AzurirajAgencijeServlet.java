...
/**
 * Servlet implementation class AzurirajAgencijeServlet
 */
@WebServlet("/AzurirajAgencijeServlet")
public class AzurirajAgencijeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public AzurirajAgencijeServlet() {
